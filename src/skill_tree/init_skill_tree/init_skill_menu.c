...
static background_t **init_background_skill_tree(background_t **background, menu_t *menu)
{
...
static button_t **init_foreground_skill_tree(button_t **foreground, menu_t *menu)
{
